      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="text-3xl font-bold tracking-tight text-slate-900 font-sans sm:text-4xl">
            Elite Dentists and Board-Certified Orthodontists
          </h2>
          <p className="mt-4 text-base text-slate-600 leading-relaxed">
            Our clinicians serve as academic researchers and board examiners, bringing world-recognized expertise to your preventive and cosmetic smile care.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {DENTISTS.map((dentist, index) => (
            <motion.div
              ...
              className="flex flex-col h-full bg-white rounded-3xl overflow-hidden border border-slate-100 shadow-xs transition-all hover:shadow-xl hover:border-teal-500/10 group"
            >
              {/* Photo */}
              ...
              <div className="p-6 flex flex-col justify-between flex-grow">
                <div>
                  ...
                  <p className="text-xs font-medium text-slate-500 italic mt-0.5 mb-3">{dentist.specialty}</p>
                ...
                <div className="mt-6 pt-4 border-t border-slate-100 flex items-center justify-between">
                  <button
                    ...
                    className="text-xs font-bold text-slate-500 hover:text-teal-600 transition-all flex items-center gap-1"
                  >
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-1 px-4 py-2 rounded-xl bg-teal-50 hover:bg-teal-600 text-teal-700 hover:text-white font-bold text-xs transition-all cursor-pointer"
                  >
